...
{
    public static void MapCreateProductEndpoint(this IEndpointRouteBuilder endpoint)
    {
        endpoint
            .MapPost("api/catalog/products", async (
...
internal class Handler : IRequestHandler<CreateProduct, CreateProductResult>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var entityEntry = (await _catalogDbContext.Products
            .AddAsync(product, cancellationToken)).Entity;
